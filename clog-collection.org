...
- [[#utilities][Utilities]]
  - [[#the-generic-method-to-get-the-js-id--for-a-js-object-of-a-clog-element][the generic method to get the js id  for a js object of a clog element]]
...
#+END_SRC
* Utilities
** the generic method to get the js id  for a js object of a clog element
#+BEGIN_SRC lisp
...
(defmethod create-clog-codemirror ((obj clog:clog-obj)
  ...
  (let ((obj (create-div obj
    ...
    (js-execute obj (format nil clog.js.codemirror.new tab-size extentions (js-id obj) (html-id obj)))
    obj))
#+END_SRC
** text-value
#+BEGIN_SRC lisp
